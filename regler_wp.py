...
HK2_min = 20.5 # Tempvorgabe für Absenkbetrieb Heizgruppe, 23.12.12, von 20 auf 20.5 erhöht
...
def main():
    ...
    #t_now = (CLIENT.read_input_registers(REGISTER["AT"], count=1, unit=1).getRegister(0))/10
    t_now = 0
